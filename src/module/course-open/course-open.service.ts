...
export class CourseOpenService {
  constructor(private courseOpenRepository: CourseOpenRepository) {}

  closeCurrentState(closeCurrentStateDto: CloseCurrentStateDto) {
    return this.courseOpenRepository.closeCurrentState(closeCurrentStateDto);
  }

  delete(deleteCourseOpenDto: DeleteCourseOpenDto) {
    return this.courseOpenRepository.delete(deleteCourseOpenDto);
  }
  findAllOneTerm(findCourseOpenDto: FindCourseOpenDto) {
  ...
  create(createCourseOpenDto: CreateCourseOpenDto) {
    return this.courseOpenRepository.create(createCourseOpenDto);
  }
